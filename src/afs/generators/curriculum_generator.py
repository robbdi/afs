...
try:
    from afs_scawful.generators.curriculum_generator import *  # type: ignore[F403]
except Exception as exc:  # pragma: no cover - compatibility path
    raise RuntimeError(
        "Module 'afs_scawful.generators.curriculum_generator' moved to the afs-scawful extension. "
