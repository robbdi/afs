...
try:
    from afs_scawful.discriminator.fake_generators import *  # type: ignore[F403]
except Exception as exc:  # pragma: no cover - compatibility path
    raise RuntimeError(
        "Module 'afs_scawful.discriminator.fake_generators' moved to the afs-scawful extension. "
